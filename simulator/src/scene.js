...
(function () {
  ...
  // runs along the machine in the direction the products travel (CAD z), z
  // across it measured from the centre of the product belt (CAD x + 2755),
  // y up from the floor. The CAD names are in the comments.
  const CELL = {
    // INFEED CONVEYOR, 4.2m LONG, 405mm WIDE, 48m/min
    belt: { x0: -2370, x1: 1830, top: 730, width: 405, bodyWidth: 580, bodyDepth: 156 },
    // Not found in the CAD: where the line of products is held, level with the arm and the camera.
    gateX: -90,
    // WELDMENT FRAME
    frame: { x0: -901, x1: 900, z0: -305, z1: 1805, height: 2140, plinth: 200 },
  ...
  const orbit = { target: new THREE.Vector3(350, 600, 700), radius: 8600, theta: -2.75, phi: 0.98 };
